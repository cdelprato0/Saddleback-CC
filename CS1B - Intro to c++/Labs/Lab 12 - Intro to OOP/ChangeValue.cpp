 ...
 * This function definition allows the user to change the value of any of
...
void ChangeValue(Sheep& fluffy, Pig& babe, Sheep& maa, float& newValue)
{
	...
	//Turning fixed off and setting precision back to 6.
	...
	do
	{
		...
		else if (newValue < 0 || newValue > 400000)
		{
			// OUTPUT - if the command is out of bounds, the user will be
			//		 re-prompted
			cout << left;
			cout << "\n**** The number " << newValue << setw(25)
				 << " is an invalid entry" << "****"
				 << "\n**** Please input a number "
					"between 0 and 400000 ****\n";
			cout << right;
	...
	//Formatting the output and selecting the correct animal.
	cout << fixed << setprecision(2);
	if(userCommand == 1)
	{
		//OUTPUT - outputs to the console the name of the animal that is
		//			being changed
		cout << "\nChanging Fluffy\'s age to " << newValue << " ...";
	...
	else if(userCommand == 2)
	{
		//OUTPUT - outputs to the console the name of the animal that is
		//			being changed
		cout << "\nChanging Maa\'s age to " << newValue << " ...";
	...
	else
	{
		//OUTPUT - outputs to the console the name of the animal that is
		//			being changed
		cout << "\nChanging Babe\'s age to " << newValue << " ...";
