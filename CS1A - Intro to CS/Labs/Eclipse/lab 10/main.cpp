...
int main()
{
	...
	cout << "TRIANGLE OBJECT"<<endl<< "     Area:     "<< "Circumference:";
	cout << endl << "	" << tarea << "		"  << tcircumference;
	cout << endl << endl << endl;
	...
	//OUTPUT - Outputs the inputs and the Area and Circumference
	cout <<"RECTANGLE OBJECT"<< endl <<"     Area:     "<<"Circumference:";
	cout << endl << "     " << rarea << " 		" <<rcircumference;
	cout << endl << endl << endl;
	
	//INPUT - read in one input from the user (radius)
	cout << "Enter the radius of the circle: "; //circle
	cin  >> radius;
	cout << endl;
	...
	//OUTPUT - Outputs the inputs and the Area and Circumference
	cout <<"CIRCLE OBJECT" << endl << "     Area:     " <<"Circumference:";
	cout << endl << " 	" << carea <<" 	"<<ccircumference;
